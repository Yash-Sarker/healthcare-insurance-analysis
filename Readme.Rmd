...
Before answering any of our questions, we wanted to ensure the data was clean. Our data contained no NA values or duplicates, so we were able to move onto the next step.
...
Although the correlation matrix and heatmap show that age has the strongest positive relationship with insurance charges, followed by BMI, we did not observe any extremely strong linear relationships. This led us to work with one key variable in mind: insurance charges are likely affected by multiple interacting factors rather than a single dominant variable. Thus, we decided to explore the effects of some combinations of the variables in our dataset on insurance.
...
When smoking status was incorporated into the analysis, the separation between smokers and non-smokers became much clearer, especially among older individuals. Smokers had higher base charges, which continued to increase as smokers got older. Non-smokers had a lower base charge, but charges still increased as they got older. Interestingly, there was a higher correlation between non-smokers, age and charges than smokers, ages, and charges. 

##put in the graph

Overall, we see that insurance charges increased as age increased, showing a positive relationship. We also saw that older smokers did have higher charges than younger smokers. 


## Sex and Charges

Our data contains a very similar amount of males and females, an important note for our analysis on the effect sex has insurance charges. Overall, males and females are charged at similar rates. Men have slightly higher charges, as well as a slightly greater IQR of charges, but the distributions between males and females are very similar.

Due to the overlap in the distributions between males and females, we wanted to look closer to see if smoking had a major effect on the charges between the sexes. Based on our faceted bloxplots, we see that smokers, regardless of sex, are charged more. However, there is practically no difference between the insurance charges of males and females for both smokers and non-smokers. 
...
To evaluate if there was a threshold where costs increased significantly, we created boxplots for smokers and non-smokers above aand below the BMI of 30. We chose 30 as the threshold because in the United States, a BMI of 30 or above is considered obese. 

From our boxplots, we can see that those with a BMI of 30 or above generally experience higher insurance chargers than those with a BMI below 30. Those above the threshold also had a higher range and IQR of charges.
...
Interestingly, we see that those with 5 children have the lowest median insurance charges, as well as the lowest variability in charges. This could be due to a lack of families in the data with 5 children, leading to a lower representation of the populaion with 5 children. 

## Regions and Charges

Our data contained a fairly even spread of families from all 4 regions. In comparing the charges by region, we see that all distributions were very similar. The southeast had a slightly greater IQR and median charge than any other region, which makes sense, since many people move to the southeast after retiring. 

As seen from our earlier study, we see know that as age increases, insurance charges increase. This could be the reason the southeast has greater variability in charges. 

We also investigated if a specific region of smokers were charged more than others. To do so, we compared the distributions of the insurance charges of smokers in each region, as well as those of non-smokers.

As expected, non-smokers were charged less in all regions than smokers, and their distributions were roughly the same. For smokers, those in the South had greater median charges than those in the north, but similar variability.

We can conclude that smokers in the South are charged slightly more, but the insurance charges of smokers don't change very much across regions.

## Critics and Improvements (please do Yash)
